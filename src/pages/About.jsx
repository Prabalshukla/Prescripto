  ...
  return (
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600">
          ...
          <p>Prescripto is committed to excellence in healthcare technology. We continuously strive to enhance our platform, integrating the latest advancements to improve user experience and deliver superior service.
            Whether you are booking your first appointment or managing ongoing care, Prescripto is here to support you every step of the way.</p>
      ...
      <div className="text-xl my-4">
        <p>WHY <span className="text-gray-700 font font-semibold">CHOOSE US</span></p>
      </div>
